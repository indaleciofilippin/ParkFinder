...
import { View, Text, StyleSheet, Dimensions, TouchableOpacity, SafeAreaView, Alert, TextInput, KeyboardAvoidingView, Platform, ActivityIndicator } from 'react-native';
